// Synthesized two-tone alarm (Web Audio oscillator sweep) - no audio asset
// needed. Used to alert the operator the moment Target Person ID confirms
// or reacquires the target (see Results.tsx).
